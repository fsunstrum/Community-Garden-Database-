...
CREATE TABLE GardenManages(
   ...
   FOREIGN KEY (garden_name) REFERENCES GardenInfo,
...
CREATE TABLE GardenerPlot(
   ...
   FOREIGN KEY (garden_address) REFERENCES 
      ...
      ON DELETE CASCADE
      ON UPDATE CASCADE,
   FOREIGN KEY (gardener_email) REFERENCES 
      Gardener(email)
      ON DELETE SET NULL
      ON UPDATE CASCADE
);
...
CREATE TABLE PlantColour(
   ...
   colour VARCHAR(20),
   FOREIGN KEY (common_name) REFERENCES PlantInfo
      ON DELETE CASCADE
      ON UPDATE CASCADE
);
...
CREATE TABLE Grows(
   ...
   FOREIGN KEY (species, genus, variety) REFERENCES 
      ...
      ON UPDATE CASCADE,
   FOREIGN KEY (plot_num) REFERENCES GardenerPlot,
   FOREIGN KEY (garden_address) REFERENCES 
      GardenNumPlotsManages(address)
);
...
INSERT INTO Donation (donation_id, donor_name, date, item) VALUES (1, 'Alice', '2024-07-01', 'Orange Seeds');
INSERT INTO Donation (donation_id, donor_name, date, item) VALUES (2, 'Bob', '2024-07-05', 'Shovel');
INSERT INTO Donation (donation_id, donor_name, date, item) VALUES (3, 'Charlie', '2024-07-10', 'Carrot Seeds');
INSERT INTO Donation (donation_id, donor_name, date, item) VALUES (4, 'Diana', '2024-07-15', 'Grape Tomato Seeds');
INSERT INTO Donation (donation_id, donor_name, date, item) VALUES (5, 'Eve', '2024-07-20', 'Lawn Chair');
...
INSERT INTO PlantInfo (species, genus, variety, common_name) VALUES ('Rosa chinensis', 'Rosa', 'Angel Wings');
...
INSERT INTO PlantColour (common_name, colour) VALUES ('Angel Wings', 'Pink');
...
INSERT INTO PlantHarvest (common_name, harvest_time) VALUES ('Angel Wings', NULL);
...
INSERT INTO Grows (species, genus, variety, plot_num, garden_address, qty, plant_date) VALUES ('Rosa chinensis', 'Rosa', 'angel wings', 4, '123 Elm St', 11, TO_DATE('2024-08-13', 'YYYY-MM-DD'));
